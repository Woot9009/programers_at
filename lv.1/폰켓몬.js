...
/*
1. nums 배열을 오름차순 정렬
2. nums[i]가 nums[i-1]과 다를 경우에만 arr배열에 push
3. 중복된 요소가 없는 arr배열에 대해 가장 많은 종류의 N/2마리를 뽑는 경우 return
  3-1. arr.length <= N/2 라면 return arr.length하면 됨
  3-2. arr.length > N/2 라면 return N/2하면 됨
*/